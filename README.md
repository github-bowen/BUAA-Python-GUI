...
```
cd existing_repo
git remote add origin https://gitlab.com/buaa-python/calendar.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/buaa-python/calendar/-/settings/integrations)
