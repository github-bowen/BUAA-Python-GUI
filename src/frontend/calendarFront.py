...
class CalenWindow(QMainWindow):
    ...
    def initUI(self):
        ...
        # 设置控件的栅格布局
        grid.addWidget(self.calendar, 0, 0, 5, 5)
        grid.addWidget(self.dateLabel, 5, 0, 1, 5)
        grid.addLayout(self.displayWidget.layout, 0, 5, 5, 1)
    ...
    def taskDisplay(self, date, dateChange):
        """
